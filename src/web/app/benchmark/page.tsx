...
const BENCHMARK_FIXTURES: BenchmarkCase[] = [
  ...
  { id: "case_5c", caseStudy: 5, failureMode: "CD-SEM Measurement Noise", waferPattern: "None", expectedCategory: "metrology", equipment: "LITHO-02", description: "Critical dimension SEM measurement noise without physical defect.", reasoningValidation: "Accurately recognized nominal yield operating conditions.", status: "PASSED" },
  { id: "case_6a", caseStudy: 6, failureMode: "Pre-Run Parameter Deviation", waferPattern: "Pre-run", expectedCategory: "process", equipment: "ETCH-07", description: "Planned lot recipe setpoints exceeding historical low-yield bounds.", reasoningValidation: "Generated 68/100 risk score and warned process engineer before run.", status: "PASSED" },
  ...
  { id: "case_6c", caseStudy: 6, failureMode: "Pre-Run Nominal Batch Release", waferPattern: "Pre-run", expectedCategory: "process", equipment: "LITHO-02", description: "Planned lot with all recipe setpoints aligned to qualified baseline.", reasoningValidation: "Scored 18/100 nominal risk and cleared lot for standard dispatch.", status: "PASSED" },
];
